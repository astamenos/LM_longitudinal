...
\begin{tabular}{l|c}
\hline
Parameter & Estimate & Std. Error & z value & Pr(>|z|) \\ \hline
...
\begin{table}[H]\begin{center}
\caption{{\bf Results of Model 2}}\label{t:model2}
\begin{tabular}{l|cccc}
\hline
Parameter & Estimate & Std. Error & z value & Pr(>|z|) \\ \hline
(Intercept) & -5.68707  &  0.22611 & -25.152 & < 2e-16 \\
regionNortheast & -2.84973  &  0.99794 & -2.856 & 0.004296 \\
regionSouth & -1.10769  &  0.37525 & -2.952 & 0.003158 \\
regionWest & 0.19967  &  0.34891 &  0.572 & 0.567142 \\
\hline
\end{tabular} 
\end{center}
\end{table}
