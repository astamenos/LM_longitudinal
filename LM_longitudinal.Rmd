...
The main dataset of interest contains information about approximately $14,500$ school districts in the U.S. There are more than $17,000$ school districts in the country. Some school districts contain a single school, whereas other contain multiple schools (___, _).

The data was collected to help the Centers for Disease Control and Prevention assess how schools were operating during the COVID-19 pandemic (___, ).
